 ...
 * @author Bryan Durac
 */
public class QUBMediaImages extends Menu1 {

	private static ImageManager img; // Defines an instance of ImageManager
	private static Console con = initConsole();; // Defines an instance of Console
	
    public QUBMediaImages() {
    	super(con, "QUB Image Manager");
	    img = initialise();
        addOption("Add Image");
        addOption("Search");
        addOption("Display All");
        addOption("Quit");
    }
	...
	public static void main(String[] args) {
		QUBMediaImages menu = new QUBMediaImages();
		int choice;
